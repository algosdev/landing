...
function ContactForm() {
  return (
    <div className={style.wrapper} id='section5'>
      <Fade>
        <div className={style.inner}>
          ...
          <div className={style.desc}>
            ...
            additional details of your project with our managers so that our
            team could get started with your project right away.
          </div>
          <form>
